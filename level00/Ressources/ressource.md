...
nous pouvons voir une comaraison entre l'input demande et la valeur 0x149c
...
Breakpoint 1, 0xf7e816d0 in __isoc99_scanf () from /lib32/libc.so.6
(gdb) i r eax
eax            0x8048636	134514230
(gdb) x/s 0x8048636
0x8048636:	 "%d"
```

%d, nous pouvons donc definir que le password est un int dont la valeur est 0x149c en hexa

transform hexa to deci: 0x149c -> 5276
