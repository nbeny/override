...
to solve the level06 we enter a size of login of 6, and we have to bypass ptrace function to get the value of serial number compared at line auth+286.
...
#### to breakpoint at the condition
...
$1 = 1234
(gdb) x/x $ebp-0x10
0xffffd698:	0x005f1af3

```

#### to solve the level06
